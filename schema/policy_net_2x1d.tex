\begin{tikzpicture}[every node/.append style={align=center, thick}]
    ...
    \node (obs_str) at ([yshift=3.4mm]obs.north) {\Large $\boldsymbol{p}_g, \dot{\boldsymbol{p}}$};
    \foreach \i in {0,...,3} {
    ...
    \draw[->, -{Stealth[width=2mm]}] ([xshift=0.8cm, yshift=-1.4cm]lidar.east) -- ([xshift=-0.2cm]lidar_cat.west) node[midway, above, yshift=4pt] () {\Large\textit{cat}};
    ...
    \node[draw, fill=white, minimum width=2*\squareSize, minimum height=\gridSizeCnn*\squareSize] (cnn_lidar) at ([xshift=2.6cm]lidar_cat) {};
        ...
        \draw (cnn_lidar.north) -- (cnn_lidar.south);
    \draw [->] ([xshift=0.2cm]lidar_cat.east) -- ([xshift=-0.2cm]cnn_lidar.west) node[midway, above, yshift=4pt] () {\Large 1D \\ \Large CNN};
    ...
    \draw [->, -{Stealth[width=2mm]}] ([xshift=0.8cm, yshift=3cm]obs.east) -- ([xshift=-0.2cm]obs_mlp.west)  node[midway, above, yshift=4pt] () {\Large FCN};
    ...
    \draw [->, -{Stealth[width=2mm]}] ([xshift=0.6cm]cnn_lidar.east) -- ([xshift=-0.2cm]flat_lidar.west)  node[midway, above, yshift=4pt] () {\Large \textit{flat.}};
    ...
    \draw [->, -{Stealth[width=2mm]}] ([xshift=0.85cm]flat_lidar.east) -- ([xshift=-0.2cm]mlp_cat_0.west) node[midway, above, xshift=-0.34cm, yshift=4pt] () {\Large \textit{cat},\\ \Large 2$\times$FCN};
    ...
    \draw [->, -{Stealth[width=2mm]}] ([xshift=0.2cm]mlp_cat_0.east) -- ([xshift=-0.2cm]mlp_mean.west)  node[midway, below, yshift=-1pt, sloped] () {\Large FCN};
    % STD
    ...
    \draw [->, -{Stealth[width=2mm]}] ([xshift=0.2cm]mlp_cat_0.east) -- ([xshift=-0.2cm]mlp_std.west)  node[midway, above, yshift=1pt, sloped] () {\Large FCN};
