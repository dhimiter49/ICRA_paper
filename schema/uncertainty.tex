\begin{tikzpicture}
    ...
    \draw[thick]{
        ([xshift=1.7cm]center1) -- ([xshift=1.7cm, yshift=2.5cm]center1) node[midway, below, sloped] () {$r + dt * \dot{\boldsymbol{p}}_{max}$}
        ([xshift=1.7cm]center1) -- ([xshift=2.5cm]center1) node[midway, below] () {$r$}
    };
    \draw[thick]
        ([xshift=3.4cm]center1) -- ([xshift=3.4cm, yshift=4.2cm]center1) node[midway, below, sloped] () {$r + dt * 2 * \dot{\boldsymbol{p}}_{max}$}
        ([xshift=3.4cm]center1) -- ([xshift=4.2cm]center1)
    ;
    \draw[thick]
        ([xshift=5.1cm]center1) -- ([xshift=5.1cm, yshift=5.9cm]center1) node[midway, below, sloped] () {$r + dt * 3 * \dot{\boldsymbol{p}}_{max}$}
